...
###get part status data from database###
...
####count the equivalent mileage(considering weather and traffic jam)###
...
def exam (part,part_mile,start_mile):
  for i in range(len(part_mile)):
    if (part_mile.mile[len(part_mile)-1] < start_mile):
      print("you do not need to maintain",part)
      day = 90
      break
    elif (part_mile.mile[0] >= start_mile):
      print("you need to mantain immediately", part)
      day = 0
      break
    elif (part_mile.mile[i] >= start_mile):
      if (i >= 0 and i <= 30):
        print("you need to mantain your cars in ", i+1, "days for ", part, "part")
        day = i+1
        break
      elif (i > 30):
        print("you do not need to maintain",part)
...
###count the left miles to maintain when they activating the service###
